...
webProcess.stdout.on('data', (data) => {
  ...
  // Capture port as soon as rsbuild announces it (before build completes)
  if (!detectedPort) {
  ...
  // Start Electron only after rsbuild finishes building (server is actually ready)
  if (detectedPort && !electronProcess && readyRegex.test(output)) {
