...
// electron-is-dev@2.0.0 is incompatible with Electron 37.x (throws before env check).
// Use BRUNO_DEV_PORT (set by dev.js) as the dev-mode signal instead.
...
app.on('ready', async () => {
  ...
  // DevTools extensions disabled: electron-devtools-installer uses deprecated
  // session APIs (getAllExtensions/loadExtension) that crash Electron 37.x.
